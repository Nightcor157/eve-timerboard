...
Для ограничения публичного просмотра ключом выполни в SQL Editor файл
`supabase_public_view_key.sql`, затем в админке задай "Новый ключ просмотра".
Обычные зрители будут вводить этот ключ на странице доски.
